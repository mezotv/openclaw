...
export const nl: TranslationMap = {
  ...
  login: {
    ...
    deviceAuthMigration: {
      banner: "Deze browser vereist na de update nog eenmalige apparaatgoedkeuring.",
      action: "Deze browser beveiligen",
      secureContextRequired:
        "Deze verouderde browser blijft tijdelijk beschikbaar. Open opnieuw via HTTPS of localhost om hem te beveiligen met apparaatidentiteit.",
      pendingUnavailable:
  ...
  chat: {
    ...
    sendErrors: {
      activeLeafChanged: "De thread is van vertakking gewisseld — controleer en verzend opnieuw.",
    },
    ...
    sessionSharing: {
      ...
      readOnlyNotice: "Alleen de eigenaar en leden van de thread kunnen erin acteren.",
    },
    sessionSuggestions: {
      suggest: "Voorstellen",
      ...
      dismiss: "Voorstel van {author} verwerpen",
