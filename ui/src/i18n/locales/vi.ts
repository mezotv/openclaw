...
export const vi: TranslationMap = {
  ...
  configForm: {
    ...
    advancedHidden: "{count} cài đặt nâng cao bị ẩn",
    advancedHiddenPlural: "{count} cài đặt nâng cao bị ẩn",
  ...
  configView: {
    ...
    formUnsafeCount: "1 cài đặt trong config này chỉ có thể chỉnh sửa dưới dạng văn bản: {paths}",
    formUnsafeCountPlural:
      "{count} cài đặt trong config này chỉ có thể chỉnh sửa dưới dạng văn bản: {paths}",
  ...
  modelSetup: {
    ...
    prepare: {
      ...
      ollamaLabel: "Ollama",
      ollamaHint: "Tải xuống một mô hình hỗ trợ công cụ từ máy chủ Ollama của bạn",
  ...
  login: {
    ...
    deviceAuthMigration: {
      ...
      secureContextRequired:
        "Trình duyệt cũ này vẫn khả dụng tạm thời. Mở lại qua HTTPS hoặc localhost để bảo mật nó bằng danh tính thiết bị.",
  ...
  chat: {
    ...
    sessionSharing: {
      menu: "Chia sẻ chuỗi",
      current: "Hiển thị chuỗi: {visibility}",
      visibility: "Hiển thị",
      shared: "Đã chia sẻ",
      readOnly: "Chỉ đọc",
      suggest: "Đề xuất",
