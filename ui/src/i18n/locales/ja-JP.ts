...
export const ja_JP: TranslationMap = {
  ...
  newSession: {
    ...
    incognito: "シークレット",
    incognitoDescription: "Gateway が再起動するまでのみこのスレッドを保持します",
  ...
  configView: {
    ...
    chatPrefs: {
      ...
      messageWidth: "メッセージ幅",
      messageWidthHint:
        "中央揃えのトランスクリプト用の任意の CSS 幅（960px、82%、min(1280px, 82%) など）。",
      messageWidthInvalid:
    ...
    formUnsafeCount: "この設定内の 1 件はテキストとしてのみ編集できます: {paths}",
    formUnsafeCountPlural: "この設定内の {count} 件はテキストとしてのみ編集できます: {paths}",
  ...
  modelSetup: {
    ...
    prepare: {
      ...
      intro: "この Gateway でローカルモデルをダウンロードまたは準備します。",
      button: "モデルをセットアップ / ダウンロード",
      ollamaLabel: "Ollama",
      ollamaHint: "Ollamaサーバーからツール対応モデルをダウンロードします",
      llamaCppLabel: "ローカルモデル（llama.cpp）",
      llamaCppHint: "約5.0 GBのローカルモデルをダウンロードします。16 GBのRAMが必要です",
    },
    manual: {
  ...
  profilePage: {
    ...
    identity: {
      ...
      menuButtonLabel: "{name}のアイデンティティとアプリメニュー",
  ...
  login: {
    ...
    deviceAuthMigration: {
      ...
      secureContextRequired:
        "このレガシーブラウザは一時的に利用できます。HTTPSまたはlocalhostで再度開き、デバイスアイデンティティで保護してください。",
      pendingUnavailable:
