...
export const de: TranslationMap = {
  ...
  modelSetup: {
    ...
    prepare: {
      ...
      ollamaLabel: "Ollama",
      ollamaHint: "Ein werkzeugfähiges Modell von deinem Ollama-Server herunterladen",
      llamaCppLabel: "Lokales Modell (llama.cpp)",
      llamaCppHint: "Ein etwa 5,0 GB großes lokales Modell herunterladen; benötigt 16 GB RAM",
    },
    manual: {
  ...
  chat: {
    ...
    sessionSharing: {
      ...
      readOnlyNotice:
        "Nur der Thread-Eigentümer und Mitglieder können in diesem Thread aktiv werden.",
    },
    sessionSuggestions: {
      suggest: "Vorschlagen",
