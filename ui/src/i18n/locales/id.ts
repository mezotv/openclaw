...
export const id: TranslationMap = {
  ...
  configView: {
    ...
    chatPrefs: {
      ...
      messageWidthHint:
        "Lebar CSS opsional untuk transkrip yang berpusat, seperti 960px, 82%, atau min(1280px, 82%).",
      messageWidthInvalid:
  ...
  chat: {
    ...
    sessionSharing: {
      ...
      readOnlyNotice: "Hanya pemilik dan anggota utas yang dapat bertindak di utas ini.",
    },
    sessionSuggestions: {
      suggest: "Sarankan",
