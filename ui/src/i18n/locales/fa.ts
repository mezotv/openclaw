...
export const fa: TranslationMap = {
  ...
  configView: {
    ...
    formUnsafeCount: "۱ تنظیم در این پیکربندی فقط به‌صورت متنی قابل ویرایش است: {paths}",
    formUnsafeCountPlural: "{count} تنظیم در این پیکربندی فقط به‌صورت متنی قابل ویرایش است: {paths}",
  ...
  modelSetup: {
    ...
    prepare: {
      ...
      ollamaLabel: "Ollama",
      ollamaHint: "دانلود یک مدل سازگار با ابزارها از سرور Ollama شما",
      llamaCppLabel: "مدل محلی (llama.cpp)",
      llamaCppHint: "دانلود یک مدل محلی تقریباً ۵.۰ گیگابایتی؛ به ۱۶ گیگابایت رم نیاز دارد",
    },
    manual: {
  ...
  chat: {
    ...
    sessionSuggestions: {
      ...
      sendNow: "اکنون پیشنهاد {author} را ارسال کنید",
      queue: "پیشنهاد {author} را در صف قرار دهید",
      edit: "پیشنهاد {author} را ویرایش کنید",
      dismiss: "پیشنهاد {author} را نادیده بگیرید",
